...
live.log_metric("avg_prec", metrics.average_precision_score(labels, predictions))
live.log_metric("roc_auc", metrics.roc_auc_score(labels, predictions))
...
prc_file = "evaluation/plots/sklearn/precision_recall.json"
...
live.log_sklearn_plot("confusion_matrix", labels.squeeze(), predictions_by_class.argmax(-1))
