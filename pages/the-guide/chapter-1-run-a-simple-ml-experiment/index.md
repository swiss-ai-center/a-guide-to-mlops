...
{% callout type="note" %} The `evaluate.py` Python script might display a
warning regarding DVC. You can safely ignore it for now. {% /callout %}
...
- **Next**: [Chapter 2: Share your ML experiment code with
