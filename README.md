...
| `--shaded` | `False` | Apply Lambertian diffuse shading and self-shadowing via a radiance render. Slower, but produces a day/night terminator and ring shadows. |
