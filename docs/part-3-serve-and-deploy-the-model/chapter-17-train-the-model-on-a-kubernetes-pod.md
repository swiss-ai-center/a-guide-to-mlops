...
!!! note
    ...
    while also demonstrating its capabilities. However, we could have also used our
    existing Google Cloud Container Registry.
...
@todo: update the above (below is new, check user for specific GCP access)
