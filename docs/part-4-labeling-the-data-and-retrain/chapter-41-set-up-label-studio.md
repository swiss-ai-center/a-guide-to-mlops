...
!!! warning
    ...
    It is necessary to utilize a Python 3.12 virtual environment for this setup.
    This requirement is due to the current incompatibility of LabelStudio with
    TensorFlow 2.20, coupled with the lack of support for Python 3.13 in TensorFlow
    2.19.
